  ...
  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-x-2 text-[20px]">
        <strong className="font-body col-span-1">{props.projectLabel}</strong>
        ...
        <strong className="font-body col-span-1 lg:row-start-2">
          {props.postedOnLabel}
        </strong>
        <p className="col-span-2 lg:row-start-2 mb-1">{props.postedOn}</p>
        <strong className="font-body col-span-1 lg:row-start-3">

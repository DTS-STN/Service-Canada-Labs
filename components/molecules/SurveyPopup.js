        ...
        <div className="col-start-8 col-span-5 ml-auto">
          <div className="max-w-[416px] bg-custom-blue-dark text-white pl-6 pr-6 pt-3 pb-6 rounded-t-lg shadow-lg">
            <button
              ...
              aria-label={
                isOpen
                  ? closeButtonLabel || t("surveyPopup.closeButtonLabel")
                  : openButtonLabel || t("surveyPopup.openButtonLabel")
              }
            >
              <span className="transition-opacity duration-300 ease-in-out">
                {isOpen
                  ? titleExpanded || t("surveyPopup.titleExpanded")
                  : titleCollapsed || t("surveyPopup.titleCollapsed")}
              </span>
              <span
            ...
            <div
              ...
              className={`transition-all duration-300 ease-in-out overflow-hidden
                ${
                  isOpen
                    ? "min-h-[180px] max-h-[400px] opacity-100"
                    : "max-h-0 opacity-0"
                }`}
            >
              <p className="mb-6">
              ...
              <div
                ...
                role="group"
                aria-label={
                  optionsGroupLabel || t("surveyPopup.optionsGroupLabel")
                }
              >
                <button
                  ref={noThanksRef}

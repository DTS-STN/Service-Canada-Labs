...
ARG NEXT_PUBLIC_AEM_GRAPHQL_ENDPOINT=https://www.canada.ca/content/_cq_graphql/decd-endc/endpoint.json
...
ENV NOTIFY_REPORT_A_PROBLEM_EMAIL=$NOTIFY_REPORT_A_PROBLEM_EMAIL

        ...
        <section className="layout-container mb-2 mt-12">
          <div className="xl:w-2/3 ">
            ...
            <ol className="ml-8 text-lg">
              ...
              <li>
                {props.locale === "en"
                  ? pageData.scFragments[0].scContentEn.json[4].content[1]
                      .content[0].value
                  : pageData.scFragments[0].scContentFr.json[4].content[1]
                      .content[0].value}
              </li>
            </ol>
            <p className="mb-5 text-sm lg:text-p">
            ...
            <ul className="list-disc list-outside pl-4 mb-10 text-sm lg:text-p ml-6">
              <li className="whitespace-pre-line mb-3">
                <b>
                  {props.locale === "en"
                    ? pageData.scFragments[0].scContentEn.json[9].content[0]
                        .content[0].value
              ...
              <li className="whitespace-pre-line mb-3">
                <b>
                  {props.locale === "en"
                    ? pageData.scFragments[0].scContentEn.json[9].content[2]
                        .content[0].value
            ...
            <Link
              href={
                props.locale === "en"
                  ? pageData.scFragments[0].scContentEn.json[12].content[0].data
                      .href
                  : pageData.scFragments[0].scContentFr.json[12].content[0].data
                      .href
              }
              locale={props.locale}
            ...
            <ol className="ml-8 text-lg">
              ...
              <li>
                {props.locale === "en"
                  ? pageData.scFragments[0].scContentEn.json[15].content[2]
                      .content[0].value
                  : pageData.scFragments[0].scContentFr.json[15].content[2]
                      .content[0].value}
              </li>
            </ol>

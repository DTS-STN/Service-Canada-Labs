      ...
      >
        ...
        <section className="layout-container">
          ...
          >
            ...
            <Link
              href={formField.privacyLink}
              locale={props.locale}
              className="block font-body hover:text-canada-footer-hover-font-blue text-canada-footer-font underline mt-28 sm:mt-0 mb-10 text-sm lg:text-p"
            >
              {formField.privacy}
            </Link>
            <ActionButton
